...
public class ArchiveMergeJob extends SMRDefinition {
	...
	public void doConfiguration(JobSubmitContext jobSubmitContext, Job currJob) throws Exception {
		...
		//Parse payLoads
		//Configure Input
		String defaultInputPaths = "/tmp/raw_archvie_process/history_at_user_merge";
		...
		String defaultOutputPath = "/tmp/raw_archvie_process/history_at_user_single";
