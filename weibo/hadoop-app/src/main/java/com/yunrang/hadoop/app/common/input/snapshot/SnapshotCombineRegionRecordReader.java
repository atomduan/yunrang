 ...
 * for each region in a {@link SnapshotCombineRegionSplit}.
 * A CombineRegionSplit can combine region from multiple regions.
 * @see SnapshotCombineRegionSplit
 * @param <K>
 * @param <V>
 */
@SuppressWarnings("rawtypes")
public class SnapshotCombineRegionRecordReader<K, V> extends RecordReader<K, V> {
	private static final Logger LOGGER = Logger.getLogger(SnapshotCombineRegionRecordReader.class);
	static final Class [] constructorSignature = new Class[]{SnapshotCombineRegionSplit.class, TaskAttemptContext.class, Integer.class};

	protected SnapshotCombineRegionSplit split;
	...
	public void initialize(InputSplit split, TaskAttemptContext context) throws IOException, InterruptedException {
		this.split = (SnapshotCombineRegionSplit)split;
	 ...
	 */
	  ...
	  */
	 public SnapshotCombineRegionRecordReader(SnapshotCombineRegionSplit split, TaskAttemptContext context, Class<? extends RecordReader<K,V>> rrClass) throws IOException {
		 this.split = split;
		 this.context = context;
