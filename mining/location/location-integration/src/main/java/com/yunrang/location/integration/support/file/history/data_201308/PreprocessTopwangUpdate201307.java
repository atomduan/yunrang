...
public class PreprocessTopwangUpdate201307 implements HistoryFilesConfig.Processor {
	private TopwangCellStationUpdater topwangCellStationUpdater;
	private ContextFileProcess contextFileProcess;
	
	public void doProcess() throws Exception {
		contextFileProcess.doSingleThreadProcess(HistoryFilesConfig.yrDataPath_201308+"/topwang_update_201307.csv", "GBK", new ContextFileProcess.LineProcessor() {
			@Override
