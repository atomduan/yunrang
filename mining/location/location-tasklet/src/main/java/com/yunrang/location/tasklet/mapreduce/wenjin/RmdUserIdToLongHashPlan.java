...
final public class RmdUserIdToLongHashPlan extends SingleMapReduceJobPlanBase {
    
	public RmdUserIdToLongHashPlan() {
    ...
    public static class InnerMapper extends Mapper<LongWritable, Text, Text, Text> {
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            context.write(new Text(userHashId+","+resId+","+score), new Text(""));
        }
    }
