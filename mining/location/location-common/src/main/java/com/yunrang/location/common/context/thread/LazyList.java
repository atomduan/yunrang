...
/* ------------------------------------------------------------ */
/**
 * Lazy List creation. A List helper class that attempts to avoid unneccessary
 * List creation. If a method needs to create a List to return, but it is
 * expected that this will either be empty or frequently contain a single item,
 * then using LazyList will avoid additional object creations by using
 * Collections.EMPTY_LIST or Collections.singletonList where possible.
 * <p>
 * <h4>Usage</h4>
 * 
 * <pre>
...
public class LazyList implements Cloneable, Serializable {
    private static final long serialVersionUID = -5521177867660572644L;
